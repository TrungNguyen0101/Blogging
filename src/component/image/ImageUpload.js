    ...
    return (
        ...
        >
            <input
                ...
                {...rest}
            />
            {/* progress != 0 và không có image => xuất hiện loading */}
            {progress !== 0 && !image && (
            ...
            {/* không có image và progress =0 => xuất hiện ảnh upload */}
            {!image && progress === 0 && (
            ...
            {/* có image => xuất hiện image và icon delete */}
            {image && (
                <Fragment>
            ...
            {/* không có image => xét width progress */}
            {!image && (
                <div
                    className="absolute h-1 bg-green-400 bottom-0 left-0 transition-all image-upload-progress"
                    style={{
